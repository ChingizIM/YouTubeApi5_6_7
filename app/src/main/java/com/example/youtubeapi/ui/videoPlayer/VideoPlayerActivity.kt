...
class VideoPlayerActivity : BaseActivity<VideoPlayerViewModel, ActivityVideoPlayerBinding>(),
    ...
    override fun onMediaMetadataChanged(mediaMetadata: MediaMetadata) {
        ...
        binding.videoTitle.text =
            mediaMetadata.title ?: mediaMetadata.displayTitle ?: "title not found"
    }

    override fun initView() {
        getDataIntent()
        binding.noInternet.rlParent.visibility = View.GONE
    ...
    override fun checkInternet() {
        CheckConnectNetwork(this).observe(this) { isConnected ->
            binding.noInternet.rlParent.isVisible = !isConnected
        }
    }
}
